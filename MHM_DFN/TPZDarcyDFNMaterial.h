...
#ifndef TPZDarcyDFNMATERIAL
#define TPZDarcyDFNMATERIAL



class TPZDarcyDFNMaterial : public TPZMatWithMem<TPZFMatrix<STATE>, TPZDiscontinuousGalerkin >  {
...
public:
     ...
     */
    TPZDarcyDFNMaterial(int matid, int dimension, int space, STATE viscosity, STATE theta, STATE Sigma);
    
    
    /** Creates a material object based on the referred object and
     *  inserts it in the vector of material pointers of the mesh.
     */
    TPZDarcyDFNMaterial(const TPZDarcyDFNMaterial &mat);
